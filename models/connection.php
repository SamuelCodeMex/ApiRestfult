...
class Connection{
	...
	static public function getColumnsData($table, $columns){
		...
		if(empty($validate)){
			...
			=============================================*/
			//agregado para evitar<b>Warning</b>:  Undefined array key 0 in <b>C:\xampp\htdocs\api\001\models\connection.php</b> on line <b>107</b><br />
	...
	/*=============================================
	Generar Token de Autenticación: se puede configuar el tiempo de duración del token.
	=============================================*/
	...
	static public function jwt($id, $email){
		...
		$token = array(
			...
			"exp" => $time + (60*60*60*24), // Tiempo en que expirará el token (1 día)
			"data" => [
